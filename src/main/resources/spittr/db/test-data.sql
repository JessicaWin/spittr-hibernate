insert into Spitter (username, password, firstname, lastname, email) values ('habuma', 'password', 'Craig', 'Walls', 'craig@habuma.com');
insert into Spitter (username, password, firstname, lastname, email) values ('mwalls', 'password', 'Michael', 'Walls', 'mwalls@habuma.com');
insert into Spitter (username, password, firstname, lastname, email) values ('chuck', 'password', 'Chuck', 'Wagon', 'chuck@habuma.com');
insert into Spitter (username, password, firstname, lastname, email) values ('artnames', 'password', 'Art', 'Names', 'art@habuma.com');
